...
void MainWindow::listClicked(){
      ...
      QHBoxLayout* acceptL=new QHBoxLayout;
       ...
       QPushButton* addParts= new QPushButton("Add parts");
       acceptL->addWidget(addParts);
...
query.next();
 ...
 chart_ptr.clear();
chart_ptr=QSharedPointer<chart>(new chart("Temperatures2"));

 chartPr_ptr.clear();
 chartPr_ptr= QSharedPointer<chart>(new chart("Pressures2"));
 ...
 ui->overhLyt->addWidget(lblOverh);
  ui->turbOverhLyt->addWidget(lblOverhTurb);
    ...
    chart_ptr.clear();
    chart_ptr=QSharedPointer<chart>(new chart("Temperatures"));

    chartPr_ptr.clear();
    chartPr_ptr= QSharedPointer<chart>(new chart("Pressures"));
